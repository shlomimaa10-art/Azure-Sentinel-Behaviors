...
- **Behaviors-rules/**: Directory containing individual YAML files for each behavior detection rule
- **rules_format.md**: Documentation explaining the structure and format of each rule file
